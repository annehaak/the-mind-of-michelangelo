!function(a) {
    ...
    o.prototype = {
        ...
        open: function(b) {
            ...
            if (b.isObj === !1) {
                ...
                for (c = 0; c < d.length; c++)
                    if (e = d[c], e.parsed && (e = e.el[0]), e === b.el[0]) {
                        n.index = c;
                        break
                    }
            } else
        ...
        _checkIfClose: function(b) {
            if (!a(b).hasClass(m)) {
                ...
                if (b === n.content[0] || a.contains(n.content[0], b)) {
                    if (c)
                        return !0
                } else if (d && a.contains(document, b))
                    return !0;
                return !1
            }
        },
        ...
        _onFocusIn: function(b) {
            return b.target === n.wrap[0] || a.contains(n.wrap[0], b.target) ? void 0 : (n._setFocus(), !1)
        },
    ...
    a.magnificPopup.registerModule("image", {
        ...
        proto: {
                ...
                var b = 0,
                    ...
                    d = function(e) {
                        L && clearInterval(L), L = setInterval(function() {
                            return c.naturalWidth > 0 ? void n._onImageHasSize(a) : (b > 200 && clearInterval(L), b++, void (3 === b ? d(10) : 40 === b ? d(50) : 100 === b && d(500)))
                        }, e)
                    };
                d(1)
            },
            getImage: function(b, c) {
                var d = 0,
                    e = function() {
                        b && (b.img[0].complete ? (b.img.off(".mfploader"), b === n.currItem && (n._onImageHasSize(b), n.updateStatus("ready")), b.hasSize = !0, b.loaded = !0, y("ImageLoadComplete")) : (d++, 200 > d ? setTimeout(e, 100) : f()))
                    },
                    f = function() {
    ...
    a.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            initZoom: function() {
                ...
                if (a.enabled && n.supportsTransition) {
                    ...
                    w("BuildControls" + d, function() {
                        if (n._allowZoom()) {
                            if (clearTimeout(i), n.content.css("visibility", "hidden"), e = n._getItemToZoom(), !e)
                                return void h();
            ...
            _getOffset: function(b) {
                ...
                var d = c.offset(),
                    e = parseInt(c.css("border-left-width"), 0),
                    f = parseInt(c.css("border-top-width"), 0),
                    g = parseInt(c.css("padding-top"), 10),
                    h = parseInt(c.css("padding-bottom"), 10);
                d.left += e, d.top -= a(window).scrollTop() - g - f;
                var i = {
                    width: c.width(),
                    height: (p ? c.innerHeight() : c[0].offsetHeight) - h - g
                };
                return O() ? i["-moz-transform"] = i.transform = "translate(" + d.left + "px," + d.top + "px)" : (i.left = d.left, i.top = d.top), i
            }
        }
    });
    var P = "iframe",
        ...
        proto: {
            ...
            getIframe: function(b, c) {
                ...
                a.each(e.patterns, function() {
                    return d.indexOf(this.index) > -1 ? (this.id && (d = "string" == typeof this.id ? d.substr(d.lastIndexOf(this.id) + this.id.length, d.length) : this.id.call(this, d)), d = this.src.replace("%id%", d), !1) : void 0
                });
                var f = {};
